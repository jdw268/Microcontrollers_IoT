...
//const char* mqtt_topicSupplyVoltage = "SupplyVoltage";  //this topic is also set on TW server
//const char* mqtt_topicLEDVoltage = "LEDVoltage";  //this topic is also set on TW server
//const char* mqtt_topic2 = "TWLEDStatus";  //this topic is also set on TW server
...
void receivedMessage(char* topic, byte* payload, unsigned int length) {
  ...
  //Update the pin that controls the LED based on input message
